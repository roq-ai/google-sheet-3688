  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of development with Google Sheet - transforming your ideas into reality with GAS."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnb29nbGUlMjBzaGVldHxlbnwwfHx8fDE2OTI0MzYxOTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@brandi1?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Brandi Redd`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of development with Google Sheet - transforming your ideas into reality with GAS.`}
            </Text>
            <Box
